...
Виджет для AmoCRM.
Генерирует кнопку в карточке сделки для воронок "Бронирование" и "Мед. центр", а также сводную информацию.
При нажатии на кнопку или ЗдравID открывает существующую или новую заявку в Здравнице. Предварительно на хосте, на котором нажимается кнопка в браузере, должен быть запущен клиент **rdesk** с флагом `/crm_on4455`.
